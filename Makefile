project3: project3.o lexer.o inputbuf.o parser.o stack.o tree.o execute.o
	g++ -std=c++11 -o project3 project3.o lexer.o inputbuf.o parser.o stack.o tree.o execute.o
...
clean:
	rm lexer.o inputbuf.o parser.o project3 stack.o project3.o tree.o execute.o